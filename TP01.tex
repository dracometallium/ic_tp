...
\makeatletter{
    ...
    \small Fecha de finalización: 04 de abril 2023
    \par
}
...
\begin{itemize}
    ...
    \item Apuntes de cátedra. Capitulo 1: Sistemas de Numeración. Disponible
        en: \url{https://pedco.uncoma.edu.ar/mod/resource/view.php?id=685472}
...
\egone{1}\egone{1}\egone{1}\egone{1}\egone{1}\egten{1}\egten{1}\egten{1}\egten{1}\eghun{1}\eghun{1}\eghun{1}\eghun{1}\eghun{1}\eghun{1}\eghun{1}\egtho{1}\egtho{1}\egtho{1}\egtentho{1} \\\\
...
\egten{1}\egone{1}\eghun{1}\egone{1}\egone{1}\egone{1}\egten{1}\egten{1}\eghun{1}\eghun{1}\eghun{1}\eghun{1}\egtho{1}\egtho{1}\egtho{1}\egtentho{1}\egone{1}\eghun{1}\egten{1}\eghun{1} \\
...
\begin{enumerate}[resume]
    ...
    \begin{enumerate*}[itemjoin=\hspace{2em}]
        ...
        \item  \egone{1}\egmil{1}\egone{1}\egmil{1}
        
        \item \egmil{1} \eghuntho{1}\eghuntho{1}\egone{1}\egmil{1}\egone{1} \egmil{1}\egone{1} \eghuntho{1}\egone{1} \egone{1}\egone{1}\egmil{1}\eghuntho{1}
