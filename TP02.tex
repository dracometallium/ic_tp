...
\vspace*{-8pt} \color{black} Representación de digital de datos\vspace*{8pt} }\par}
\makeatother
...
\pagestyle{fancy}
\lhead{\footnotesize TP N° 2 - Representación de digital de datos}
...
de punto (coma) flotante, y la suma de números enteros en binario.
