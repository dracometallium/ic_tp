...
\begin{enumerate}
    ...
    \item ¿Cuál es la representación de $32_{12}$ en las siguientes bases?
    ...
    \item ¿Cuál es rango de representación del los  sistemas \emph{de complemento a
        dos}, \emph{signo magnitud} y \emph{sin signo} con 7 bits?

    \item ¿Cual es la representación en \emph{punto fijo} y \emph{complemento
        a 2} de los siguientes números si se utilizan 6 bits para la parte
        entera y 2 para la parte fraccionaria? Indicar cual es el error de
    ...
    \item ¿Cuál es la representación hexadecimal del número $-18.6$ cuando es
    ...
    \item ¿Cuál es la representación hexadecimal de la codificación
        en \emph{ASCII} la cadena ``\emph{Final IC/22}''?
    ...
    \item Considerando la imagen que se muestra abajo, aplique el esquema de
        ...
        rojo. Muestre el resultado final expresado en hexadecimal.
