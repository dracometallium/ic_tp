...
\makeatletter{
    ...
    \textbf{
        ...
        Arquitectura y organización de computadoras (continuación)
        \vspace*{8pt}
    }\\
...
\pagestyle{fancy}
\lhead{\footnotesize TP N° 5 - Arquitectura y organización de computadoras
(continuación)}
...
\begin{enumerate}
    ...
    \item Analice y responda las siguientes preguntas, justificando su
        ...
        \begin{enumerate}
            ...
            \item ¿Qué rango de datos numéricos puede manejar el \emph{MCBE}?
                ¿Cuál es el rango de valores del acumulador?
            ...
            \item ¿Qué utilidad tendría un programa que no hiciera ningún uso
                de la Unidad de Entrada/Salida para comunicar sus resultados?
            ...
            \item ¿Cómo se podría aumentar la cantidad de instrucciones
                ...
                la longitud de los programas que puede correr la máquina?
