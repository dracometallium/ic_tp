...
\makeatletter{
    ...
    \textbf{
        Recuperatorio del trabajo práctico obligatorio N° 1\\
        \large \vspace*{-8pt} \color{black}
        ~
        \vspace*{8pt}
    }\\
    \small Fecha de entrega: 16 de Agosto
    \par
}
...
\pagestyle{fancy}
\lhead{\footnotesize Recuperatorio del trabajo práctico obligatorio}
...
\url{https://pedco.uncoma.edu.ar/mod/assign/view.php?id=352665}. Incluir las
...
Ante cualquier problema técnico, no duden contactarnos por correo electrónico
o cualquier otro medio oficial.
